...
<!-- wp:social-links {"iconColor":"custom-white-smoke","iconColorValue":"#f8f6f0","iconBackgroundColor":"custom-red-brick","iconBackgroundColorValue":"#b22222","size":"has-large-icon-size","className":"is-style-default"} -->
<ul class="wp-block-social-links has-large-icon-size has-icon-color has-icon-background-color is-style-default"><!-- wp:social-link {"url":"https://wordpress.org","service":"wordpress"} /-->
